    ...
    >
      ...
      <div className={`relative w-full max-w-4xl max-h-[90vh] overflow-auto rounded-xl border shadow-2xl p-6 md:p-8 ${isDark ? 'bg-slate-900 border-slate-700 text-slate-100' : 'bg-white border-slate-200 text-slate-900'}`}>
        ...
        <div className="mt-6 space-y-5 text-sm leading-6">
          <section>
            <h3 className={`text-base font-semibold ${isDark ? 'text-indigo-300' : 'text-indigo-700'}`}>1. What This App Does</h3>
          ...
          <section>
            <h3 className={`text-base font-semibold ${isDark ? 'text-indigo-300' : 'text-indigo-700'}`}>2. Quick Start</h3>
          ...
          <section>
            <h3 className={`text-base font-semibold ${isDark ? 'text-indigo-300' : 'text-indigo-700'}`}>3. Understanding Results</h3>
            <p className={isDark ? 'text-slate-300' : 'text-slate-700'}>
          ...
          <section>
            <h3 className={`text-base font-semibold ${isDark ? 'text-indigo-300' : 'text-indigo-700'}`}>4. Export Options</h3>
            <p className={isDark ? 'text-slate-300' : 'text-slate-700'}>
          ...
          <section>
            <h3 className={`text-base font-semibold ${isDark ? 'text-indigo-300' : 'text-indigo-700'}`}>5. Theme and Accessibility</h3>
            <p className={isDark ? 'text-slate-300' : 'text-slate-700'}>
          ...
          <section>
            <h3 className={`text-base font-semibold ${isDark ? 'text-indigo-300' : 'text-indigo-700'}`}>6. Common Troubleshooting</h3>
            <p className={isDark ? 'text-slate-300' : 'text-slate-700'}>
