...
export const SummaryDisplay: React.FC<SummaryDisplayProps> = ({ summary, coverImageUrl, isDark, aiProvider, aiModel }) => {
  ...
  return (
    <div className="w-full animate-fade-in">
      <h2 className="text-xl font-bold text-slate-800 mb-4">Generated Analysis</h2>
        ...
        <div className="w-full text-left">
          ...
          <div className="mt-6 text-right">
            <button
              ...
              className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-300 text-white font-bold py-2 px-4 rounded-xl transition-all shadow-md shadow-blue-100 disabled:cursor-not-allowed"
              aria-live="polite"
            >
              {isCopied ? (
                <>
